...
@RxKotlinViewDsl fun ViewDsl.rowFill(vararg elements: View) = ll(LinearLayout.HORIZONTAL, Gravity.CENTER_VERTICAL or Gravity.START, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, elements)
@RxKotlinViewDsl fun ViewDsl.rowFillLeft(vararg elements: View) = ll(LinearLayout.HORIZONTAL, Gravity.CENTER_VERTICAL or Gravity.LEFT, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, elements)
@RxKotlinViewDsl fun ViewDsl.rowFillStart(vararg elements: View) = ll(LinearLayout.HORIZONTAL, Gravity.CENTER_VERTICAL or Gravity.START, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, elements)
@RxKotlinViewDsl fun ViewDsl.rowFillCenter(vararg elements: View) = ll(LinearLayout.HORIZONTAL, Gravity.CENTER_VERTICAL or Gravity.CENTER_HORIZONTAL, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, elements)
@RxKotlinViewDsl fun ViewDsl.rowFillRight(vararg elements: View) = ll(LinearLayout.HORIZONTAL, Gravity.CENTER_VERTICAL or Gravity.RIGHT, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, elements)
@RxKotlinViewDsl fun ViewDsl.rowFillEnd(vararg elements: View) = ll(LinearLayout.HORIZONTAL, Gravity.CENTER_VERTICAL or Gravity.END, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, elements)
...
@RxKotlinViewDsl fun ViewDsl.columnFill(vararg elements: View) = ll(LinearLayout.VERTICAL, Gravity.TOP or Gravity.CENTER_HORIZONTAL, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, elements)
...
@RxKotlinViewDsl fun ViewDsl.columnTopFill(vararg elements: View) = ll(LinearLayout.VERTICAL, Gravity.TOP or Gravity.CENTER_HORIZONTAL, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, elements)
...
@RxKotlinViewDsl fun ViewDsl.columnCenterFill(vararg elements: View) = ll(LinearLayout.VERTICAL, Gravity.CENTER_VERTICAL or Gravity.CENTER_HORIZONTAL, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, elements)
...
@RxKotlinViewDsl fun ViewDsl.columnBottomFill(vararg elements: View) = ll(LinearLayout.VERTICAL, Gravity.BOTTOM or Gravity.CENTER_HORIZONTAL, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, elements)

@RxKotlinViewDsl fun ViewDsl.frame(vararg elements: View) = FrameLayout(context).apply {
...
@RxKotlinViewDsl fun ViewDsl.horizontalScroll(view: View) = HorizontalScrollView(context).apply {
    addView(view, view.flparams.apply {
...
@RxKotlinViewDsl fun ViewDsl.flipper(vararg elements: View, setup: ViewFlipper.() -> Unit = {}) = ViewFlipper(context).apply {
