...
class ObservablePropertiesTest {
    ...
    @Test fun merge(){
        val sourceA = StandardProperty("walk")
        val sourceB = StandardProperty("ing")
        var read = ""
    ...
    @Test fun nullStuff(){
        val sourceA = StandardProperty<String?>(null)
        val sourceB = StandardProperty<String?>(null)
        var read = ""
        val r = sourceA.combine(sourceB){ a, b -> a + b }
        r.observableNN.subscribeBy { value ->
            println(value)
    ...
    @Test fun flatMap(){
        val source = StandardProperty<MutableProperty<String>>(StandardProperty("a"))
        var read = ""
        ...
        assertEquals("c", read)
        source.value = StandardProperty("d")
        assertEquals("d", read)
